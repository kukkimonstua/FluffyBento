            ...
            if (animationWindowSynchroSelection)
            {
                ...
                if (animationWindowRefreshDone)
                {
                    if (EditorWindow.focusedWindow != uAw.instance)
                    {
                        ...
                        {
                            bindings = animationWindowSynchroSelectionBindings;
                        }
                        else
                        {
                        ...
                        if (vaw.editorSettings.settingPropertyStyle != EditorSettings.PropertyStyle.Default)
                        {
                            if (bindings.Count > 0)
                            {
                                var filterBindings = new HashSet<EditorCurveBinding>(bindings);
                ...
                beforeAnimationWindowRefreshDone = animationWindowRefreshDone;
            }
            else if (animationWindowFilterBindings != null)
            {
                var animationWindowRefreshDone = uAw.IsDoneRefresh();
