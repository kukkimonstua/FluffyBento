...
namespace VeryAnimation
{
    public class Language
    {
        ...
        public enum Help
        {
            ...
            SettingsDummyObjectMode_Clone,
            SettingsDummyObjectMode_Color,
            SettingsDummyObjectMode_Transparent,
        ...
        private static readonly GUIContent[][] LanguageHelps = new GUIContent[(int)LanguageType.Total][]
        {
            ...
            new GUIContent[]
            {
                ...
                new GUIContent("Original", "Same as original"),
                new GUIContent("Color", "Change Color"),
                new GUIContent("Transparent", "Translucent display"),
            ...
            new GUIContent[]
            {
                ...
                new GUIContent("Original", "オリジナルと同じです"),
                new GUIContent("Color", "オリジナルから色を変更します"),
                new GUIContent("Transparent", "半透明表示です"),
